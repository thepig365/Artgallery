    ...
    <div className="space-y-4">
        ...
        {AXES.map(({ key, label, sublabel, weight }) => (
          ...
          >
            <div className="flex items-center justify-between mb-2">
              <span className="text-caption font-medium text-gallery-muted uppercase tracking-wide">
                {key} &middot; {label}
              </span>
              <span className="text-micro text-gallery-muted/60">
                {weight}%
              </span>
            </div>
            ...
            <p className="text-caption text-gallery-muted mt-0.5">{sublabel}</p>
            {/* Score bar */}
      ...
      {finalV != null && (
        <div className="bg-gallery-accent/5 border border-gallery-accent/20 rounded-lg p-4 flex items-center justify-between">
          <div>
            <p className="text-caption font-medium text-gallery-accent uppercase tracking-wide">
              Mend Index (V)
            </p>
            <p className="text-micro text-gallery-muted mt-0.5">
