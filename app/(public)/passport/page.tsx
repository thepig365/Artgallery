    ...
    <div>
      ...
      <section className="bg-family-navy text-white">
        <Container className="py-20 sm:py-28">
          ...
          <h1 className="mb-5 max-w-2xl font-serif text-3xl font-semibold leading-tight sm:text-4xl md:text-5xl">
          ...
          <p className="mb-8 max-w-xl text-base leading-relaxed text-white/75 sm:text-lg">
            ...
            controlled, and Bayview-mediated way. Artwork Passport records and
            QR-linked documentation included.
          </p>
